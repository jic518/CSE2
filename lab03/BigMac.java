...
//this program will use the scanner class to obtain from the user
//how many Big Macs there are, how much it will cost, and the tax.
//it will then display the total cost
