...
public class Enigma1{
  public static void main(String []args){ //added s after arg
    double percent;
   ...
   /*if(1-x/100==0.93)  //when the user enters 7
      ...
      //erased this statement because it will only display remaining proportion if user enters following numbers
   }
}
